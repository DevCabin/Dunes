...
<?php echo $dunes_options['opt-text']; ?>
               </div>
                           ...
                           <div class="surgical-blk">
                             ...
                             <?php if (get_field('main_image')) { ?>
                               <a href="<?php echo get_permalink();?>">
                                 <div class="eclipse">
                                    <figure><img src="<?php the_field('main_image');?>"  width="264" height="264" alt="img"></figure>
                                 </div>
                               </a>
                             <?php } ?>
                              ...
                              <div class="surgical-in">
                                 ...
                                 <!--p>We offer a full range of periodontal therapy to treat all periodontal disease from the earliest to the most advanced cases.
                                   Most recently, a dual wavelength laser- assisted surgical treatment protocol has been adopted and used with great success for
                                   the treatment of moderate to advanced periodontal cases. The benefits of this minimally invasive laser protocol are many.
                                   It is extremely effective with fewer long term side effects including minimal recession of the gingival tissue following
                                   treatment and reduced incidence of cold hypersensitivity. It is also capable of regenerating missing periodontal
                                   attachment-including bone. Generally, patients are very pleased with the results.</p-->
...
<?php endwhile; endif; ?>
                  ...
                  <div class="education">
                     ...
                     <?php echo $dunes_options['services-footer']; ?>
                  </div>
